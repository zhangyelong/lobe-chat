...
We provide a [Docker image][docker-release-link] for you to deploy the BianjieAI service on your private device.
...
<Steps>
  ...
  Use the following command to start the BianjieAI service with one click:
  ...
  - For the complete list of environment variables supported by BianjieAI, please refer to the [Environment Variables](/zh/self-hosting/environment-ariable) section.
