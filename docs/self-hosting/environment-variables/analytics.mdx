...
We have integrated several free/open-source data analytics services in BianjieAI for collecting user usage data. Here are environment variables that you can use.
