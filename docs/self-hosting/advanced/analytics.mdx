...
To better help analyze the usage of BianjieAI users, we have integrated several free/open-source data analytics services in BianjieAI for collecting user usage data, which you can enable as needed.
