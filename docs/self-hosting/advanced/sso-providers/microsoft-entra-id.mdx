...
<Steps>
  ...
  Go back to the "Microsoft Entra ID" interface, enter "Users", click on "New user", fill in the user information, and click on "Create" to create a user for using BianjieAI.
...
<Callout>After successful deployment, users will be able to authenticate and use BianjieAI using the users configured in Microsoft Entra ID.</Callout>
