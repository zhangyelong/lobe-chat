...
<Steps>
  ...
  | ------------------------ | -- | ------------------------------------------------------------------------------------------- |
  | `ENABLE_OAUTH_SSO`       | Required | Enable Single Sign-On (SSO) for BianjieAI. Set to `1` to enable SSO.                                                    |
...
<Callout type={'info'}>
  After a successful deployment, users will be able to use BianjieAI by authenticating with the users configured in Authentik.
</Callout>
