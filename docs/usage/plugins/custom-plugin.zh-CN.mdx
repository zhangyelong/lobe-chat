...
如果你希望安装一个不在 BianjieAI 插件商店中的插件，例如自己开发的 BianjieAI，你可以点击「自定义插件」进行安装：

<Video src="https://github.com/lobehub/lobe-chat/assets/28616219/034a328c-8465-4499-8f93-fdcdb03343cd" />

此外，BianjieAI 的插件机制兼容了 ChatGPT 的插件，因此你可以一键安装相应的 ChatGPT 插件。
...
如果你希望自行开发一个 BianjieAI 的插件，欢迎查阅 [插件开发指南](/zh/usage/plugins/development) 以扩展你的 AI 智能助手的可能性边界！
