---
title: 在 BianjieAI 中使用 Groq
image: https://github.com/lobehub/lobe-chat/assets/34400653/cf368841-f8e6-4cc5-b81d-09f82ef0afd9
---

# 在 BianjieAI 中使用 Groq

<Image alt={'在 BianjieAI 中使用 Groq'} cover src={'https://github.com/lobehub/lobe-chat/assets/34400653/d0d08d98-a8d2-4b97-97c0-24a4f01d7eac'} />

Groq 的 [LPU 推理引擎](https://wow.groq.com/news_press/groq-lpu-inference-engine-leads-in-first-independent-llm-benchmark/) 在最新的独立大语言模型（LLM）基准测试中表现卓越，以其惊人的速度和效率重新定义了 AI 解决方案的标准。通过 BianjieAI 与 Groq Cloud 的集成，你现在可以轻松地利用 Groq 的技术，在 BianjieAI 中加速大语言模型的运行。
...
接下来，在助手的模型选项中，选中一个 Groq 支持的模型，就可以在 BianjieAI 中体验 Groq 强大的性能了。
