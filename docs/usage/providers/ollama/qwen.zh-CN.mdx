...
<Image alt={'在 BianjieAI 中使用 Qwen'} cover src={'https://github.com/lobehub/lobe-chat/assets/28616219/7a5fd01a-9fed-49c1-93a3-422269213f19'} />
...
现在，通过 BianjieAI 与 [Ollama](https://ollama.com/) 的集成，你可以轻松地在 BianjieAI 中使用 通义千问。

本文档将指导你如何在 BianjieAI 中使用通义千问本地部署版：
...
接下来，你就可以使用 BianjieAI 与本地 Qwen 模型对话了。
