...
<Image alt={'Using Qwen in BianjieAI'} cover src={'https://github.com/lobehub/lobe-chat/assets/28616219/7a5fd01a-9fed-49c1-93a3-422269213f19'} />
...
Now, through the integration of BianjieAI and [Ollama](https://ollama.com/), you can easily use Qwen in BianjieAI. This document will guide you on how to use the local deployment version of Qwen in BianjieAI:
...
<Steps>
  ...
  In the BianjieAI conversation page, open the model selection panel, and then select the Qwen model.
  ...
  <Callout type={'info'}>
    If you do not see the Ollama provider in the model selection panel, please refer to [Integration with Ollama](/en/self-hosting/examples/ollama) to learn how to enable the Ollama provider in BianjieAI.
  </Callout>
</Steps>

Next, you can have a conversation with the local Qwen model in BianjieAI.
